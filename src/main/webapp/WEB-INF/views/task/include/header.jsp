...
<link rel="stylesheet"	href="${pageContext.request.contextPath}/resources/css/index.css?a=9">  
<link rel="stylesheet"	href="${pageContext.request.contextPath}/resources/css/task.css?a=9">
