...
<link rel="stylesheet"	href="${pageContext.request.contextPath}/resources/css/index.css?a=1">
<link rel="stylesheet"	href="${pageContext.request.contextPath}/resources/css/task.css?a=1">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
</head>
<body>    
	<nav class="navbar navbar-light navbar-fixed-top"  id="header">
			<ul class="nav navbar-nav">
				 <li>
				 	<a href="#" class="dropdown-toggle border_right nav_addBtn" data-toggle="dropdown">
			...
			<ul class="nav navbar-nav navbar-right">
				<li> 
					<a href="#" class="dropdown-toggle border_left" data-toggle="dropdown">
						<span class="nav_btn_tit">${workVO.name}</span>  
						<span class="glyphicon glyphicon-chevron-down"></span> 
					</a>  
					<ul class="dropdown-menu">   
			          <li>
			          	<a href="${pageContext.request.contextPath}/user/logout" class="nav_workspace" data-wcode="${workVO.wcode}">
