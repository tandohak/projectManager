	...
	public ResponseEntity<String> emailAuth(Model model,@RequestBody String email) {
		...
		try {
			...
			sendMail.setText(new StringBuffer().append("<h1>메일인증</h1>")
					.append("<a href='http://hongyoonpyo.cafe24.com/projectManager/user/join/signUp?user_email=").append(email)
	...
	public ResponseEntity<String> inviteTeam(@RequestBody HashMap<String, Object> map) {
		...
		try {
			...
			for (String email : emails) {
				...
				sendMail.setText(new StringBuffer().append("<h1>메일인증</h1>")
						.append("<a href='http://hongyoonpyo.cafe24.com/projectManager/task/"+wcode)
